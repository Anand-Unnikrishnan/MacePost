					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<div class="search_container ml-auto">
							<div class="weather">
								...
								<div class="temperature"><a href="#" class="temperature">10 New Notifications</a></div>
							</div>
							<form action="#">
								...
								<div class="col">
									<div class="home_slider_content">
										...
										<div class="home_slider_item_title">
											<a href="post.html"><% //out.print(tdata.tweet); %></a>
										</div>
					...
					<div class="main_content">
						...
						<div class="blog_section">
							<div class="section_panel d-flex flex-row align-items-center justify-content-start">
								<div class="section_title">Tweets by MACians</div>
							...
							<%ArrayList<TweetData> tweetdata = (ArrayList<TweetData>) request.getAttribute("tweetdata");
	  							...
	  							for(TweetData tdata : tweetdata){ %>
									...
									<div class="card card_default card_small_no_image grid-item">
										<div class="card-body">
											<div class="card-title card-title-small"><a href="post.html"><% out.print(tdata.tweet); %></a></div>
											<small class="post_meta"><a href="#"> <% out.print(tdata.user_id); %> </a> &nbsp;<i class="material-icons" style="font-size:15px;position:relative;top:3px;">access_time</i><% out.print(tdata.datetime); %></small>
										</div>
									</div>
