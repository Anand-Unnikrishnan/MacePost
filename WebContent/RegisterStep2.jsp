					...
					<div class="col-lg-6 offset-lg-3">
						...
						<div class="post_comment">
							<div class="contact_form_container">
								<h3>Register</h3>
								<div class="progress">
								  <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">50% Completed</div>
								</div>
								<form action="RegisterStep2" method="post">
									...
									<% } %>
									<input type="text" class="contact_input contact_input_name" placeholder="Your Name" required="required" name="username" <% if(request.getAttribute("username")!=null){ %> value="<% out.print(request.getAttribute("username")); %>" <% } %>>
									<input type="tel" class="contact_input contact_input_name" name="phone" placeholder="Phone" <% if(request.getAttribute("phone")!=null){ %> value="<% out.print(request.getAttribute("phone")); %>" <% } %> required="required" pattern="[0-9]{10}">
									<input type="hidden" name="_token" value="<% out.print(request.getAttribute("token")); %>">
									<br>
									<br>
									<p>Select year of study:</p>
									<select name="current_year" class="contact_input contact_input_name">
