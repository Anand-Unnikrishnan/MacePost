						...
						<div class="post_comment">
							<div class="contact_form_container">
								...
								<form action="Register" method="post">
									...
									<% } %>
									<input type="text" class="contact_input contact_input_name" placeholder="Admission no" required="required" name="admissionno" <% if(request.getAttribute("admissionno")!=null){ %> value="<% out.print(request.getAttribute("admissionno")); %>" <% } %>><br>
									<input type="password" class="contact_input contact_input_password" placeholder="Password" required="required" name="password">
									<input type="password" class="contact_input contact_input_password" placeholder="Confirm Password" required="required" name="confirmpass">
									<input type="hidden" name="_token" value="<% out.print(request.getAttribute("token")); %>">
									<button type="submit" class="contact_button">Register</button>
								</form>
								<br>
